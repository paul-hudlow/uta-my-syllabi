...
public class CreateCourseController extends ActionBarActivity 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Parse.initialize(this,"tDHQuyM07LOHaIEzPJPrMP2EKCC0j3ik6mmTQ9Xp", "ZtXxrCSSp90ca4pmWGbLGanXEarRFR6BtPIwSVXM");		
	...
	public void createCourse(View view) {
		...
		AutoCompleteTextView textView = (AutoCompleteTextView) findViewById(R.id.create_course_name);
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_dropdown_item_1line, CloudDataHelper.getSchoolList(schoolName));
